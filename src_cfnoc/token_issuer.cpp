...
bool token_issuer::set_token(int mem_c, NoximCoord src_coord, int core_id){
	...
	if(src_coord.x == 8 ){slice_id = 8;}  // column 4 choose slice 4
	if(src_coord.x == 9 ){slice_id = 9;}  // column 5 choose slice 5
	if(src_coord.x == 10 ){slice_id = 10;}  // column 6 choose slice 6
	if(src_coord.x == 11 ){slice_id = 11;}  // column 7 choose slice 7
