...
int NoximProcessingElement::get_slice(NoximCoord src_coord, NoximCoord dest_coord){
	...
	if (is_mc(src_coord)){
		if(coord2Id(src_coord) == m1){
					...
					switch(dest_coord.x){
					case 1:
						return 0; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 2:
					...
					case 9:
						...
						break;
					case 10:
						return 9; //cout<< "Slice chosen is 3"<< endl;
						break;
					case 11:
						return 10; //cout<< "Slice chosen is 3"<< endl;
						break;
					case 0:
						return 11; //cout<< "Slice chosen is 3"<< endl;
						break;
					default:
		...
		if(coord2Id(src_coord) == m2){
					...
					case 11:
						...
						break;
					case 0:
						return 0; //cout<< "Slice chosen is 3"<< endl;
						break;
					default:
						return 0; //cout<< "Slice chosen is 4"<< endl;
						break;
		...
		if(coord2Id(src_coord) == m4){
					...
					case 6:
						...
						break;
					case 7:
						return 9; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 8:
						return 10; //cout<< "Slice chosen is 3"<< endl;
						break;
		...
		if(coord2Id(src_coord) == m5){
					...
					case 5:
						...
						break;
					case 6:
						return 9; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 7:
						return 10; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 8:
						return 11; //cout<< "Slice chosen is 3"<< endl;
						break;
		...
		if(coord2Id(src_coord) == m6){
					...
					case 4:
						...
						break;
					case 5:
						return 9; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 6:
						return 10; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 7:
						return 11; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 8:
						return 0; //cout<< "Slice chosen is 3"<< endl;
						break;
		...
		if(coord2Id(src_coord) == m7){
					...
					case 4:
						...
						break;
					case 5:
						return 10; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 6:
						return 11; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 7:
						return 0; //cout<< "Slice chosen is 2"<< endl;
						break;
					case 8:
						return 1; //cout<< "Slice chosen is 3"<< endl;
						break;
		...
		if(coord2Id(src_coord) == m8){
					...
					case 4:
						...
						break;
					case 5:
						return 11; //cout<< "Slice chosen is 0"<< endl;
						break;
					case 6:
						return 0; //cout<< "Slice chosen is 1"<< endl;
						break;
					case 7:
