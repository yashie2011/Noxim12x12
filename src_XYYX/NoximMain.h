...
enum mem_controllers {m1 = 132, m2 = 133, m3 = 134, m4 = 135, m5 = 136, m6 = 137, m7 = 138, m8 = 139,
                      m9 = 140, m10 = 141, m11 = 142, m12 = 143};
...
inline bool is_mc(NoximCoord src_coord)
{
	if( coord2Id(src_coord) == m1 || coord2Id(src_coord) == m2 || coord2Id(src_coord) == m3
			...
			|| coord2Id(src_coord) == m7 || coord2Id(src_coord) == m8 || coord2Id(src_coord) == m9 || coord2Id(src_coord) == m10
			|| coord2Id(src_coord) == m11 || coord2Id(src_coord) == m12)
				return true;
	else
		return false;
}
