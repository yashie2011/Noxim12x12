...
void NoximNoC::gam()   //needs change while expanding
{
	...
	MC12_time = 5;
		...
		if(gam_counter >= GAM_COMPUTE_TIME){
			...
			mc_size.push_back(t[id2Coord(m9).x][id2Coord(m9).y]->pe->get_reply_queue_size()) ;
			mc_size.push_back(t[id2Coord(m10).x][id2Coord(m10).y]->pe->get_reply_queue_size()) ;
			mc_size.push_back(t[id2Coord(m11).x][id2Coord(m11).y]->pe->get_reply_queue_size()) ;
			mc_size.push_back(t[id2Coord(m12).x][id2Coord(m12).y]->pe->get_reply_queue_size()) ;
			...
			mc_reqs.push_back(t[id2Coord(m9).x][id2Coord(m9).y]->pe->get_num_reqs()) ;
			mc_reqs.push_back(t[id2Coord(m10).x][id2Coord(m10).y]->pe->get_num_reqs()) ;
			mc_reqs.push_back(t[id2Coord(m11).x][id2Coord(m11).y]->pe->get_num_reqs()) ;
			mc_reqs.push_back(t[id2Coord(m12).x][id2Coord(m12).y]->pe->get_num_reqs()) ;
			...
			uint ratio1, ratio2, ratio3, ratio4, ratio5, ratio6, ratio7, ratio8, ratio9, ratio10, ratio11, ratio12;
			...
			if(min_score >0 ){
				...
				ratio9 = gam_scores[8]/(min_score);
				ratio10 = gam_scores[9]/(min_score);
				ratio11 = gam_scores[10]/(min_score);
				ratio12 = gam_scores[11]/(min_score);
				
				int tot_time_window = 5 * MEM_CONTROLLERS;
				MC1_time = floor(tot_time_window*ratio1/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC2_time = floor(tot_time_window*ratio2/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC3_time = floor(tot_time_window*ratio3/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC4_time = floor(tot_time_window*ratio4/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC5_time = floor(tot_time_window*ratio5/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC6_time = floor(tot_time_window*ratio6/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC7_time = floor(tot_time_window*ratio7/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC8_time = floor(tot_time_window*ratio8/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC9_time = floor(tot_time_window*ratio5/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC10_time = floor(tot_time_window*ratio6/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC11_time = floor(tot_time_window*ratio7/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));
				MC12_time = floor(tot_time_window*ratio8/(ratio1+ratio2+ratio3+ratio4+ratio5+ratio6+ratio7+ratio8+ratio9+ratio10+ratio11+ratio12));

				MC1_time = MC1_time + MC2_time;
				MC2_time = MC3_time + MC4_time;
				MC3_time = MC5_time + MC6_time;
				MC4_time = MC7_time + MC8_time;
				MC5_time = MC9_time + MC10_time;
				MC6_time = MC11_time + MC12_time;
...
void NoximNoC::enable_mcs(){
	if(reset.read()){
		...
		t[id2Coord(m9).x][id2Coord(m9).y]->fcr->reset_send_enable();
		t[id2Coord(m10).x][id2Coord(m10).y]->fcr->reset_send_enable();
		t[id2Coord(m11).x][id2Coord(m11).y]->fcr->reset_send_enable();
		t[id2Coord(m12).x][id2Coord(m12).y]->fcr->reset_send_enable();
	...
	if(enable_timer < 5 * MEM_CONTROLLERS){
		if((enable_timer >= 0) && (enable_timer < MC1_time)){
			...
			//cout<<" gam set node m2 to enable"<<endl
			...
			t[id2Coord(m7).x][id2Coord(m7).y]->fcr->reset_send_enable();
			t[id2Coord(m8).x][id2Coord(m8).y]->fcr->reset_send_enable();
			t[id2Coord(m9).x][id2Coord(m9).y]->fcr->set_send_enable();
			t[id2Coord(m10).x][id2Coord(m10).y]->fcr->set_send_enable();
			t[id2Coord(m11).x][id2Coord(m11).y]->fcr->reset_send_enable();
			t[id2Coord(m12).x][id2Coord(m12).y]->fcr->reset_send_enable();

			t[id2Coord(m9).x][id2Coord(m9).y]->fcr->set_fast_line(0);
			t[id2Coord(m10).x][id2Coord(m10).y]->fcr->set_fast_line(1);
			...
			t[id2Coord(m9).x][id2Coord(m9).y]->fcr->reset_send_enable();
			t[id2Coord(m10).x][id2Coord(m10).y]->fcr->reset_send_enable();
			t[id2Coord(m11).x][id2Coord(m11).y]->fcr->set_send_enable();
			t[id2Coord(m12).x][id2Coord(m12).y]->fcr->set_send_enable();

			t[id2Coord(m11).x][id2Coord(m11).y]->fcr->set_fast_line(0);
			t[id2Coord(m12).x][id2Coord(m12).y]->fcr->set_fast_line(1);
